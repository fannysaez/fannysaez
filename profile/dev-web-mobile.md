...
| **Intégrations** | ![Stripe](https://img.shields.io/badge/Stripe-Paiements-635BFF) <img src="../assets/icons/svg/brevo-icon.svg" height="20" alt="Brevo" /> <img src="../assets/icons/svg/resend-icon.svg" height="20" alt="Resend" /> ![jsPDF](https://img.shields.io/badge/jsPDF-PDF-E74C3C) | Paiements, emails transactionnels, génération PDF |
